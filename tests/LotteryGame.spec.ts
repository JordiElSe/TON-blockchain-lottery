...
describe('LotteryGame', () => {
    ...
    beforeEach(async () => {
        ...
        winnersMap.set(toNano('40'), 1); // one winner takes 30% of the prize
        winnersMap.set(toNano('20'), 2); // two winners take 20% of the prize
        winnersMap.set(toNano('5'), 3); // three winners take 10% of the prize
